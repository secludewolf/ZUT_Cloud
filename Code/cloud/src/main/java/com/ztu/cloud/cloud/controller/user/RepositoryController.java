...
public class RepositoryController {
	...
	public ResultResponseEntity getRepository(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	...
	public ResultResponseEntity createFile(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	...
	public ResultResponseEntity createFolder(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	...
	public ResultResponseEntity moveFile(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	...
	public ResultResponseEntity moveFolder(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	...
	public ResultResponseEntity copyFile(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	...
	public ResultResponseEntity copyFolder(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	...
	public ResultResponseEntity renameFile(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	...
	public ResultResponseEntity renameFolder(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	 ...
	 */
	@DeleteMapping
	public ResultResponseEntity deleteFromRepository(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	...
	public ResultResponseEntity restoreFromRecycleBin(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	...
	public ResultResponseEntity deleteFromRecycleBin(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
	                                                 @RequestBody DeleteFileFromRecyclebin parameter) {
	...
	public ResultResponseEntity cleanRecycleBin(@RequestHeader(TokenUtil.TOKEN_HEADER) @NotBlank(message = "Token不能为空") String token,
