...
public interface PreviewService {
     ...
     * @return 预览信息
     */
    PreviewPhoto previewUserPhoto(String token, String repositoryId, String fileId);
     ...
     * @param fileId       文件ID
     */
    PreviewDocument previewUserDocument(String token, String repositoryId, String fileId);
}
