...
public class ShareManageServiceImpl implements ShareManageService {
	 ...
	 */
	@Override
	public ResultResponseEntity getShareList(String token, Integer pageNumber, Integer pageSize, String sortKey, String sortType) {
		...
		List<Share> result;
		try {
			result = this.shareDao.getShares();
		} catch (Exception e) {
			e.printStackTrace();
