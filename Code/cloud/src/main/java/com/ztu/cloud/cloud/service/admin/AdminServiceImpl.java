...
public class AdminServiceImpl implements AdminService {
	 ...
	 */
	@Override
	public ResultResponseEntity getUserListManage(String token, Integer pageNumber, Integer pageSize, String sortKey, String sortType) {
		int id = TokenUtil.getId(token);
		Admin admin = this.adminDao.getAdminById(id);
		if (admin == null) {
			return ResultConstant.USER_NOT_FOUND;
	 ...
	 */
	@Override
	public ResultResponseEntity getAdminListManage(String token, Integer pageNumber, Integer pageSize, String sortKey, String sortType) {
		int id = TokenUtil.getId(token);
		Admin admin = this.adminDao.getAdminById(id);
		if (admin == null) {
			return ResultConstant.USER_NOT_FOUND;
		...
		List<Admin> result;
		try {
			result = this.adminDao.getAdmins();
		} catch (Exception e) {
			e.printStackTrace();
			result = new LinkedList<>();
		}
