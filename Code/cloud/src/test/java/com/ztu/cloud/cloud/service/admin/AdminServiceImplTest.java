...
class AdminServiceImplTest {
    ...
    void before() {
        ...
        //创建测试账户
        this.admin = new Admin("lichen", "000000", "123456@qq.com", "18600000000", "测试账号", 1);
    ...
    void deleteUserManage() throws Exception {
        String url = "/admin/user";
        User user = new User("lichen", "000000", "123456@qq.com", "测试账号");
        ...
        System.out.println("status:" + status);
        System.out.println("content:" + content);
        user = this.userMapper.getUserByEmail("123456@qq.com");
        this.userRepositoryDao.deleteById(user.getRepoId());
        this.userMapper.deleteUserById(user.getId());
        assert status == 200;
    }
    ...
    void deleteAdminManage() throws Exception {
        String url = "/admin/admin";
        Admin admin = new Admin("lichen1", "000000", "1234561@qq.com", "186000000001", "测试账号", 1);
        this.adminMapper.insertAdmin(admin);
        String request = new JSONObject()
                .put("id", admin.getId())
                .toString();
        ...
        System.out.println("status:" + status);
        System.out.println("content:" + content);
        admin = this.adminMapper.getAdminByEmail("1234561@qq.com");
        this.adminMapper.deleteAdminById(admin.getId());
        assert status == 200;
    }
